    ...
    <section className="text-gray-700 body-font overflow-hidden bg-white dark:bg-gray-900 dark:text-white">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <img 
            alt={product.title} 
            className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200 dark:border-gray-700 transition-transform duration-300 transform hover:scale-105" 
            src={product.thumbnail || "https://www.whitmorerarebooks.com/pictures/medium/2465.jpg"} 
          />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            {/* Thương hiệu (danh mục sản phẩm) và tiêu đề */}
